...
| IA             | **Vercel AI Gateway** vía SDK `ai@6` (ADR-0005/0007) | Asistencia LLM del onboarding: propone paleta + borrador de descripción (**no** horario — ADR-0007), propose-only. Modelo fijado en S10a: `openai/gpt-4o-mini` (constante única swappable en `suggest-style-action.ts`, `"provider/model"` plano por el Gateway). |
