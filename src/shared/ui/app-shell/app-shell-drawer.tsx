...
// Drawer mobile del shell (ADR-0023). Wrapper Client agnóstico: cualquier
// contenido como `children`. `<AppShell>` lo usa para envolver el `<nav>`
// del sidebar en mobile, pero el componente no asume sidebar — es un drawer
// genérico toggle-able. Promovido a `shared/ui/app-shell/` desde el
// histórico `nav-hub/ui/sidebar-drawer.tsx` del Hub V1; misma semántica.
//
...
// que envuelve este componente. Acá sólo se gestiona el toggle.
