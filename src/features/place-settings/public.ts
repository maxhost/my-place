...
// la cobertura va por piezas puras + tipo/build + smoke vivo.
//
// Sub-feature Dominio promovida a slice propio (`src/features/custom-domain/`)
// en S4.5 del plan custom-domain V1 — ver `docs/decisions/0028-custom-domain-
// slice-promotion.md`. Los consumers del settings que necesiten la sección
// Dominio importan ahora de `@/features/custom-domain/public`, NO de acá.
//
