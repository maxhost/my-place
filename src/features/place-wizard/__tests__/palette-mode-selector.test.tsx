...
const LABELS: WizardLabels = {
  ...
  invalidNotice: "x", errorNotice: "x", accountFailedNotice: "x",
  assistButton: "x", assistLoading: "x", assistNeedDescription: "x",
  assistUnavailable: "x", assistProposedTitle: "x", assistProposedHint: "x",
  assistPaletteLabel: "x", assistDescriptionLabel: "x",
  assistApplyPalette: "x", assistApplyDescription: "x", assistApplied: "x",
